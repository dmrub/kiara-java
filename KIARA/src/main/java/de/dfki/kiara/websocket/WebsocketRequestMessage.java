 ...
 */
public class WebsocketRequestMessage extends TransportMessage {
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(WebsocketRequestMessage.class);
