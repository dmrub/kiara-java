...
import dfki.sb.zerociceproject.Main.MarketDataEntry;
import dfki.sb.zerociceproject.Main.QuoteRequest;
import dfki.sb.zerociceproject.Main.RelatedSym;
...
public static MarketData createMarketData() {
        ...
        data.mdEntries[0] = createMarketEntryData();
        data.mdEntries[1] = createMarketEntryData();
        data.mdEntries[2] = createMarketEntryData();
        return data;
    }
    ...
    public static QuoteRequest createQuoteRequestData() {
        ...
        req.related[0] = createRelatedSymData();
        req.related[1] = createRelatedSymData();
        req.related[2] = createRelatedSymData();
        return req;
    }
